...
## Features
- Simulation of asset paths using geometric Brownian motion
- Estimation of option price and 95% confidence interval
- Parametric study: strike price, volatility, time step
